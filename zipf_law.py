...
def showPlt(res):
    ...
    plt.xlabel('frequency', fontsize=14, fontweight='bold', fontproperties='SimHei')
    plt.ylabel('rank', fontsize=14, fontweight='bold', fontproperties='SimHei')
    plt.grid(True)
    plt.show()


if __name__ == '__main__':
    files_path = file_name(r'E:\NLP1\datasets')
